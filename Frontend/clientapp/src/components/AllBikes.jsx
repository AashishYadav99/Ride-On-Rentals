  ...
  return (
    <>
        <div className="bg-info" style={{ display:"flex" ,height:"80px",marginTop:"200px"}}>
          <h1 style={{marginTop:"15px",marginLeft:"20px"}}>All Bikes</h1>
        <input
          className="fs-5"
          type="text"
                  ...
                  <td>
                    <div style={{ marginBottom: "5px", marginLeft: "0px",marginLeft:"300px" }}>
                      <div style={{ fontSize: "40px", fontFamily: "Times New Roman" }}>
                        ...
                        <span className="me-5" style={{ font: "15px" }}>{bike.model}</span>
                      ...
                      <div style={{ fontSize: "40px", fontFamily: "Times New Roman" }}>
                        ...
                        <span className="font20 latoBlack me-5">{bike.NumberOfSeats}</span>
                        <span style={{ font: "20px", fontWeight: "bold" }}>VehicleNo :</span>
                        <span className="font20 latoBlack me-5">{bike.vehicleNo}</span>
                        <i className="fas fa-gas-pump me-2" style={{ fontSize: "36px", color: "red" }}></i>
                        <span className="font20 latoBlack">{bike.FuelType}</span>
                      </div>
                      <div style={{ fontSize: "40px", fontFamily: "Times New Roman" }}>
                        <span style={{ font: "20px", fontWeight: "bold" }}>Rent :</span>
                        <span className="font20 latoBlack me-5">{bike.rent}</span>
