...
function UserAllScooty() {
  ...
  const Filter = (event) => {
    ...
    if (searchTerm === "") {
      ...
      setRecord(
        scooty.filter((scooty) => scooty.model.toLowerCase().includes(searchTerm))
      );
    }
  };
    ...
    <>
      ...
      <div className=" form-control" style={{ display: "flex", height: "80px",backgroundColor:"#e5b36a" }}>
        ...
        <input
          className="fs-5"
          type="text"
          placeholder="Search Scooty By Model"
          onChange={Filter}
          style={{
            width: "300px",
            height: "50px",
      ...
      <div className="conatiner">
        <div className="row">
              {record.map((scooty, index) => (
                <div className="col-md-4 mb-4" key={index}>
                  <div className="card ">
                    <ScootySlider images={scooty.image} />
                  </div>
                        ...
                        <td>
                          ...
                          >
                            ...
                            >
                              ...
                              <span className="me-5">{scooty.company}</span>
                              <span
                                style={{ font: "20px", fontWeight: "bold" }}
                              >
                                Color :{" "}
                              </span>
                              <span className="me-5">{scooty.color}</span>
                            </div>
                            <div
                              style={{
                                fontSize: "40px",
                            ...
                            >
                              ...
                              <Link to={`/BookingForm/${scooty._id}`}>
                                <button
                                  type="button"
